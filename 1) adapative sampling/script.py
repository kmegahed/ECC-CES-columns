...
mdb.models[mod1].DisplacementBC(name='BC-1', createStepName='Step-1',  region=region, u1=0.0, u2=0.0, u3=L/30.0, ur1=L/50000.0, ur2=L/50000.0, ur3=L/20000.0, amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='',  localCsys=None)
a = mdb.models[mod1].rootAssembly
r1 = a.referencePoints
refPoints2=(r1[RFid2], )
