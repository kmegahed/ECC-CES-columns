...
B=300.0;H=600.0;lam=5.0;fysteel=230.0;fe=25.0;fr=250.0;d_steel=0.3;ro_rebar=0.01;tf_tw=1.50;cH=60;cB=50;
...
n2=[]
for i in n:
    n2.append([i.label,i.coordinates[0]+L/3500.0*(25.0*slender-7.0)*np.sin(i.coordinates[2]/L*pi),i.coordinates[1],i.coordinates[2]])
...
n2=[]
for i in n:
    n2.append([i.label,i.coordinates[0],i.coordinates[1],i.coordinates[2]-L/3500.0*(25.0*slender-7.0)*np.sin(i.coordinates[0]/L*pi)])
...
for i in range(n_Rep):
    ...
    a.translate(instanceList=('Part-4-'+str(i+1), ), vector=(L/3500.0*(25.0*slender-7.0)*np.sin(zz/L*pi), 0.0, zz))
...
mdb.models[mod1].DisplacementBC(name='BC-1', createStepName='Step-1',  region=region, u1=0.0, u2=0.0, u3=L/350.0*(1.6+lam*0.01), ur1=UNSET, ur2=UNSET, ur3=0.0, amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='',  localCsys=None)
a = mdb.models[mod1].rootAssembly
r1 = a.referencePoints
refPoints2=(r1[RFid2], )
